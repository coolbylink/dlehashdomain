...
Внимание, плагин предназначен для разработчиков, не используйте ключ в качестве рабочего проекта, уважайте разработчиков. Лучше приобрести официальный ключ, чем потерять проект. 
