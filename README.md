...
```php
Версия 3.3 - начало разработки обновления запланировано на 10 февраля 2020г.
Планируется:
1. Кнопка добавления ХЕШ кодов.
2. Автоматический NULLED системы где предустановлен DLE Hash Domain.
3. AJAX генерация ХЕШ кодов: (/index.php?do=keygen)
4. Оптимизация кода
```
...
Поддержка данной ветки прекращена.
